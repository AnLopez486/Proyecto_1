...
#TAREA
    ...
    def _mostrarArbol(self, nodo_raiz):
        self.profundidad = 8
        for i in range(0, 8):
            print("      ")

        if(nodo_raiz != None):
            self.mostrarArbol(nodo_raiz.hijoIzq)
            print(str(nodo_raiz.valor) + '     ')
            self.mostrarArbol(nodo_raiz.hijoDer)
...
if __name__ == "__main__":
    ...
    #arbol.agregarNodos(13)
    #arbol.agregarNodos(14)
    #arbol.agregarNodos(20)
